 ...
 */
function pw_get_image_colors( $image_path, $num = 6, $image_format = null ){
...
/**
 * Gets a more sophisticated array of color values.
 */
function pw_get_image_color_meta( $vars ){
	...
	if( !empty( $vars['image_path'] ) ){
		$hex_values = pw_get_image_colors( $vars['image_path'], $vars['number'], $vars['image_format'] );
	}
